...
diff --git a/src/components/com_foos/src/Model/CategoryModel.php b/src/components/com_foos/src/Model/CategoryModel.php
new file mode 100644
index 00000000..fe53c596
--- /dev/null
+++ b/src/components/com_foos/src/Model/CategoryModel.php
@@ -0,0 +1,492 @@
+<?php
+/**
+ * @package     Joomla.Site
...
+	}
+}
diff --git a/src/components/com_foos/src/Service/Category.php b/src/components/com_foos/src/Service/Category.php
new file mode 100644
index 00000000..21238298
--- /dev/null
+++ b/src/components/com_foos/src/Service/Category.php
@@ -0,0 +1,38 @@
+<?php
+/**
+ * @package     Joomla.Site
...
+	}
+}
diff --git a/src/components/com_foos/src/View/Category/HtmlView.php b/src/components/com_foos/src/View/Category/HtmlView.php
new file mode 100644
index 00000000..027d7c65
--- /dev/null
+++ b/src/components/com_foos/src/View/Category/HtmlView.php
@@ -0,0 +1,110 @@
+<?php
+/**
+ * @package     Joomla.Site
...
+	}
+}
diff --git a/src/components/com_foos/tmpl/category/default.php b/src/components/com_foos/tmpl/category/default.php
new file mode 100644
index 00000000..dd16a29a
--- /dev/null
+++ b/src/components/com_foos/tmpl/category/default.php
@@ -0,0 +1,20 @@
+<?php
+/**
+ * @package     Joomla.Site
...
+	?>
+</div>
diff --git a/src/components/com_foos/tmpl/category/default.xml b/src/components/com_foos/tmpl/category/default.xml
new file mode 100644
index 00000000..60593438
--- /dev/null
+++ b/src/components/com_foos/tmpl/category/default.xml
@@ -0,0 +1,56 @@
+<?xml version="1.0" encoding="utf-8"?>
+<metadata>
+	<layout title="COM_FOOS_CATEGORY_VIEW_DEFAULT_TITLE">
...
+	</fields>
+</metadata>
diff --git a/src/components/com_foos/tmpl/category/default_items.php b/src/components/com_foos/tmpl/category/default_items.php
new file mode 100644
index 00000000..9c18f9c9
--- /dev/null
+++ b/src/components/com_foos/tmpl/category/default_items.php
@@ -0,0 +1,61 @@
+<?php
+/**
+ * @package     Joomla.Site
