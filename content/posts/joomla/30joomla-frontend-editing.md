...
index 0aca19d5..8aee99f2 100644
...
index 00000000..f8857d3d
--- /dev/null
+++ b/src/administrator/components/com_foos/src/Service/HTML/Icon.php
@@ -0,0 +1,198 @@
+<?php
+/**
+ * @package     Joomla.Site
...
+	}
+}
diff --git a/src/components/com_foos/forms/foo.xml b/src/components/com_foos/forms/foo.xml
new file mode 100644
index 00000000..37a9c36b
--- /dev/null
...
+	</fields>
+</form>
diff --git a/src/components/com_foos/src/Controller/FooController.php b/src/components/com_foos/src/Controller/FooController.php
new file mode 100644
index 00000000..d476b67b
--- /dev/null
+++ b/src/components/com_foos/src/Controller/FooController.php
@@ -0,0 +1,226 @@
+<?php
+/**
+ * @package     Joomla.Site
...
+	}
+}
diff --git a/src/components/com_foos/src/Model/FormModel.php b/src/components/com_foos/src/Model/FormModel.php
new file mode 100644
index 00000000..17861d3a
--- /dev/null
+++ b/src/components/com_foos/src/Model/FormModel.php
@@ -0,0 +1,224 @@
+<?php
+/**
+ * @package     Joomla.Site
...
+	}
+}
diff --git a/src/components/com_foos/src/View/Form/HtmlView.php b/src/components/com_foos/src/View/Form/HtmlView.php
new file mode 100644
index 00000000..aa234d8c
--- /dev/null
+++ b/src/components/com_foos/src/View/Form/HtmlView.php
@@ -0,0 +1,176 @@
+<?php
+/**
+ * @package     Joomla.Site
...
index f4e516eb..3f1907c9 100644
...
+	</div>
+</form>
diff --git a/src/components/com_foos/tmpl/form/edit.xml b/src/components/com_foos/tmpl/form/edit.xml
new file mode 100644
index 00000000..c866c9b8
--- /dev/null
+++ b/src/components/com_foos/tmpl/form/edit.xml
@@ -0,0 +1,14 @@
+<?xml version="1.0" encoding="utf-8"?>
+<metadata>
+	<layout title="COM_FOOS_FORM_VIEW_DEFAULT_TITLE">
