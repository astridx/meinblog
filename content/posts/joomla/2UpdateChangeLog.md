...
> Magst du eine Prüfsumme verwenden? Sieh dir die Testbeschreibung in diesem [PR](https://github.com/joomla/joomla-cms/pull/30076) an, wenn du nicht weißt wie du dies umsetzt. Unter Ubuntu Linux ist es möglich über die Konsole mit `sha256sum -b meineDatei.zip` oder `sha284sum -b meineDatei.zip` die Prüfsumme zu berechnen.
