---
date: 2019-12-08
title: 'Joomla 4: Erweiterung erstellen - Teil 8 - Die Datenbank nutzen'
template: post
thumbnail: '../thumbnails/joomlatut.png'
slug: jooomla-erweiterung-8
categories:
  - Entwicklung
tags:
  - Tutorial
...
So nutzt du die Joomla-Datenbank.
...
<li class="d2h-file-list-line">
    ...
    <td class="d2h-info">
        <div class="d2h-code-line d2h-info">@@ -35,6 +35,7 @@</div>
    </td>
</tr><tr>
...
<div class="line-num2">22</div>
    ...
    <td class="d2h-ins">
        <div class="d2h-code-line d2h-ins">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">class FooModel extends AdminModel</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<div class="line-num2">25</div>
    ...
    <td class="d2h-ins">
        <div class="d2h-code-line d2h-ins">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">	 * The type alias for this content type.</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<div class="line-num2">45</div>
    ...
    <td class="d2h-ins">
        <div class="d2h-code-line d2h-ins">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">		&#x2F;&#x2F; Get the form.</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<div class="line-num2">46</div>
    ...
    <td class="d2h-ins">
        <div class="d2h-code-line d2h-ins">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">		$form = $this-&gt;loadForm(&#x27;com_foos.foo&#x27;, &#x27;foo&#x27;, array(&#x27;control&#x27; =&gt; &#x27;jform&#x27;, &#x27;load_data&#x27; =&gt; $loadData));</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<div class="line-num2">48</div>
    ...
    <td class="d2h-ins">
        <div class="d2h-code-line d2h-ins">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">		if (empty($form))</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<div class="line-num2">56</div>
    ...
    <td class="d2h-ins">
        <div class="d2h-code-line d2h-ins">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">	 * Method to get the data that should be injected in the form.</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<div class="line-num2">58</div>
    ...
    <td class="d2h-ins">
        <div class="d2h-code-line d2h-ins">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">	 * @return  mixed  The data for the form.</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<div class="line-num2">62</div>
    ...
    <td class="d2h-ins">
        <div class="d2h-code-line d2h-ins">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">	protected function loadFormData()</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<div class="line-num2">66</div>
    ...
    <td class="d2h-ins">
        <div class="d2h-code-line d2h-ins">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">		$data = $this-&gt;getItem();</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<div class="line-num2">68</div>
    ...
    <td class="d2h-ins">
        <div class="d2h-code-line d2h-ins">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">		$this-&gt;preprocessData(&#x27;com_foos.foo&#x27;, $data);</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<div class="line-num2">76</div>
    ...
    <td class="d2h-ins">
        <div class="d2h-code-line d2h-ins">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">	 * @param   \Joomla\CMS\Table\Table  $table  The Table object</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<div class="line-num2">82</div>
    ...
    <td class="d2h-ins">
        <div class="d2h-code-line d2h-ins">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">	protected function prepareTable($table)</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<div class="line-num2">84</div>
    ...
    <td class="d2h-ins">
        <div class="d2h-code-line d2h-ins">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">		$table-&gt;generateAlias();</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<div id="d2h-805974" class="d2h-file-wrapper" data-lang="php">
    ...
    <td class="d2h-code-linenumber d2h-info"></td>
    <td class="d2h-info">
        <div class="d2h-code-line d2h-info">@@ -0,0 +1,61 @@</div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
      <div class="line-num1"></div>
...
<div class="line-num2">23</div>
    ...
    <td class="d2h-ins">
        <div class="d2h-code-line d2h-ins">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">class FooTable extends Table</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<div class="line-num2">28</div>
    ...
    <td class="d2h-ins">
        <div class="d2h-code-line d2h-ins">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">	 * @param   DatabaseDriver  $db  Database connector object</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<div class="line-num2">32</div>
    ...
    <td class="d2h-ins">
        <div class="d2h-code-line d2h-ins">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">	public function __construct(DatabaseDriver $db)</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<div class="line-num2">34</div>
    ...
    <td class="d2h-ins">
        <div class="d2h-code-line d2h-ins">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">		$this-&gt;typeAlias = &#x27;com_foos.foo&#x27;;</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<div class="line-num2">43</div>
    ...
    <td class="d2h-ins">
        <div class="d2h-code-line d2h-ins">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">	 * @return  string</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<div class="line-num2">45</div>
    ...
    <td class="d2h-ins">
        <div class="d2h-code-line d2h-ins">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">	public function generateAlias()</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<div class="line-num2">47</div>
    ...
    <td class="d2h-ins">
        <div class="d2h-code-line d2h-ins">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">		if (empty($this-&gt;alias))</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<div class="line-num2">49</div>
    ...
    <td class="d2h-ins">
        <div class="d2h-code-line d2h-ins">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">			$this-&gt;alias = $this-&gt;name;</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<div class="line-num2">52</div>
    ...
    <td class="d2h-ins">
        <div class="d2h-code-line d2h-ins">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">		$this-&gt;alias = ApplicationHelper::stringURLSafe($this-&gt;alias, $this-&gt;language);</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<div class="line-num2">54</div>
    ...
    <td class="d2h-ins">
        <div class="d2h-code-line d2h-ins">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">		if (trim(str_replace(&#x27;-&#x27;, &#x27;&#x27;, $this-&gt;alias)) == &#x27;&#x27;)</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<div class="line-num2">56</div>
    ...
    <td class="d2h-ins">
        <div class="d2h-code-line d2h-ins">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">			$this-&gt;alias = Factory::getDate()-&gt;format(&#x27;Y-m-d-H-i-s&#x27;);</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<div class="line-num2">59</div>
    ...
    <td class="d2h-ins">
        <div class="d2h-code-line d2h-ins">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">		return $this-&gt;alias;</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<div id="d2h-047734" class="d2h-file-wrapper" data-lang="php">
    ...
    <td class="d2h-code-linenumber d2h-info"></td>
    <td class="d2h-info">
        <div class="d2h-code-line d2h-info">@@ -0,0 +1,74 @@</div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
      <div class="line-num1"></div>
...
<div class="line-num2">20</div>
    ...
    <td class="d2h-ins">
        <div class="d2h-code-line d2h-ins">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn"> * View to edit a foo.</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<div class="line-num2">27</div>
    ...
    <td class="d2h-ins">
        <div class="d2h-code-line d2h-ins">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">	 * The \JForm object</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<div class="line-num2">34</div>
    ...
    <td class="d2h-ins">
        <div class="d2h-code-line d2h-ins">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">	 * The active item</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<div class="line-num2">41</div>
    ...
    <td class="d2h-ins">
        <div class="d2h-code-line d2h-ins">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">	 * Display the view.</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<div class="line-num2">57</div>
    ...
    <td class="d2h-ins">
        <div class="d2h-code-line d2h-ins">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">	 * Add the page title and toolbar.</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<div class="line-num2">63</div>
    ...
    <td class="d2h-ins">
        <div class="d2h-code-line d2h-ins">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">	protected function addToolbar()</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<div class="line-num2">65</div>
    ...
    <td class="d2h-ins">
        <div class="d2h-code-line d2h-ins">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">		Factory::getApplication()-&gt;input-&gt;set(&#x27;hidemainmenu&#x27;, true);</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<div class="line-num2">67</div>
    ...
    <td class="d2h-ins">
        <div class="d2h-code-line d2h-ins">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">		$isNew = ($this-&gt;item-&gt;id == 0);</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<div class="line-num2">69</div>
    ...
    <td class="d2h-ins">
        <div class="d2h-code-line d2h-ins">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">		ToolbarHelper::title($isNew ? Text::_(&#x27;COM_FOOS_MANAGER_FOO_NEW&#x27;) : Text::_(&#x27;COM_FOOS_MANAGER_FOO_EDIT&#x27;), &#x27;address foo&#x27;);</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<div class="line-num2">71</div>
    ...
    <td class="d2h-ins">
        <div class="d2h-code-line d2h-ins">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">		ToolbarHelper::apply(&#x27;foo.apply&#x27;);</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<tr>
    <td class="d2h-code-linenumber d2h-info"></td>
    <td class="d2h-info">
        <div class="d2h-code-line d2h-info">@@ -39,6 +42,27 @@ class HtmlView extends BaseHtmlView</div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-cntx">
      <div class="line-num1">39</div>
...
<div class="line-num2">60</div>
    ...
    <td class="d2h-ins">
        <div class="d2h-code-line d2h-ins">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">		&#x2F;&#x2F; Get the toolbar object instance</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<div class="line-num2">61</div>
    ...
    <td class="d2h-ins">
        <div class="d2h-code-line d2h-ins">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">		$toolbar = Toolbar::getInstance(&#x27;toolbar&#x27;);</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<div class="line-num2">19</div>
    ...
    <td class="d2h-ins">
        <div class="d2h-code-line d2h-ins">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">$layout  = &#x27;edit&#x27;;</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<div class="line-num2">20</div>
    ...
    <td class="d2h-ins">
        <div class="d2h-code-line d2h-ins">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">$tmpl = $input-&gt;get(&#x27;tmpl&#x27;, &#x27;&#x27;, &#x27;cmd&#x27;) === &#x27;component&#x27; ? &#x27;&amp;tmpl=component&#x27; : &#x27;&#x27;;</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<div id="d2h-900341" class="d2h-file-wrapper" data-lang="php">
    ...
    <td class="d2h-code-linenumber d2h-info"></td>
    <td class="d2h-info">
        <div class="d2h-code-line d2h-info">@@ -7,8 +7,59 @@</div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-cntx">
...
<div class="line-num2"></div>
    ...
    <td class="d2h-del d2h-change">
        <div class="d2h-code-line d2h-del d2h-change">
            <span class="d2h-code-line-prefix">-</span>
            <span class="d2h-code-line-ctn">&lt;?php <del>foreach</del> (<del>$this-&gt;items</del> <del>as</del> <del>$i</del> <del>=&gt;</del> <del>$item) : ?&gt;</del></span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-del d2h-change">
...
<div class="line-num2"></div>
    ...
    <td class="d2h-del d2h-change">
        <div class="d2h-code-line d2h-del d2h-change">
            <span class="d2h-code-line-prefix">-</span>
            <span class="d2h-code-line-ctn"><del>&lt;?php</del> <del>echo $item-&gt;name; ?&gt;</del></span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-del d2h-change">
...
<div class="line-num2"></div>
    ...
    <td class="d2h-del d2h-change">
        <div class="d2h-code-line d2h-del d2h-change">
            <span class="d2h-code-line-prefix">-</span>
            <span class="d2h-code-line-ctn"><del>&lt;?php</del> <del>endforeach;</del> <del>?&gt;</del></span>
        </div>
    </td>
</tr><tr>
...
<div class="line-num2">15</div>
    ...
    <td class="d2h-ins d2h-change">
        <div class="d2h-code-line d2h-ins d2h-change">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn"><ins>&lt;form action=&quot;</ins>&lt;?php <ins>echo</ins> <ins>Route::_</ins>(<ins>&#x27;index.php?option=com_foos&#x27;);</ins> <ins>?&gt;&quot;</ins> <ins>method=&quot;post&quot;</ins> <ins>name=&quot;adminForm&quot;</ins> <ins>id=&quot;adminForm&quot;&gt;</ins></span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins d2h-change">
...
<div class="line-num2">16</div>
    ...
    <td class="d2h-ins d2h-change">
        <div class="d2h-code-line d2h-ins d2h-change">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn"><ins>	&lt;div</ins> <ins>class=&quot;row&quot;&gt;</ins></span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins d2h-change">
...
<div class="line-num2">17</div>
    ...
    <td class="d2h-ins d2h-change">
        <div class="d2h-code-line d2h-ins d2h-change">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn"><ins>        &lt;div class=&quot;col-md-12&quot;</ins>&gt;</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins d2h-change">
...
<div class="line-num2">18</div>
    ...
    <td class="d2h-ins d2h-change">
        <div class="d2h-code-line d2h-ins d2h-change">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn"><ins>			&lt;div</ins> <ins>id=&quot;j-main-container&quot;</ins> <ins>class=&quot;j-main-container&quot;&gt;</ins></span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<div class="line-num2">28</div>
    ...
    <td class="d2h-ins">
        <div class="d2h-code-line d2h-ins">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">									&lt;?php echo Text::_(&#x27;COM_FOOS_TABLE_TABLEHEAD_NAME&#x27;); ?&gt;</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<div class="line-num2">37</div>
    ...
    <td class="d2h-ins">
        <div class="d2h-code-line d2h-ins">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">						$n = count($this-&gt;items);</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<div class="line-num2">45</div>
    ...
    <td class="d2h-ins">
        <div class="d2h-code-line d2h-ins">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">									&lt;?php $editIcon = &#x27;&lt;span class=&quot;fa fa-pencil-square mr-2&quot; aria-hidden=&quot;true&quot;&gt;&lt;&#x2F;span&gt;&#x27;; ?&gt;</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
