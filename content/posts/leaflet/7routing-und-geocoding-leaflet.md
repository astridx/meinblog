...
Als erstes sehen wir uns kurz an, was sich hinter dem Begriff Routing versteckt.
...
Fangen wir von vorne an. Es ist nämlich meiner Meinung nach auch spannend,
...
Ansonsten ist meine kurze Zusammenfassung hier im Kapitel vielleicht interessant für Sie.
...
Damit die Software zur Routenberechnung fehlerfrei funktioniert,
...
herunterladen.
Danach haben wir die Option `geocoder` des Plugins Leaflet Routing Machine mit dem
Wert `L.Control.Geocoder.nominatim({})` belegt.
