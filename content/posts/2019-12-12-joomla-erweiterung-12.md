---
date: 2019-12-12
title: 'Joomla 4: Erweiterung erstellen - Teil 12 - ACL'
template: post
thumbnail: '../thumbnails/joomlatut.png'
slug: jooomla-erweiterung-12
categories:
  - Entwicklung
tags:
  - Tutorial
...
So handhabst du Benutzerrechte in deiner Komponente.
...
<div id="diff">
    ...
    <div class="d2h-file-list-header">
        <span class="d2h-file-list-title">Files changed (10)</span>
...
<li class="d2h-file-list-line">
    <span class="d2h-file-name-wrapper">
      <svg aria-hidden="true" class="d2h-icon d2h-added" height="16" title="added" version="1.1" viewBox="0 0 14 16"
           width="14">
          <path d="M13 1H1C0.45 1 0 1.45 0 2v12c0 0.55 0.45 1 1 1h12c0.55 0 1-0.45 1-1V2c0-0.55-0.45-1-1-1z m0 13H1V2h12v12zM6 9H3V7h3V4h2v3h3v2H8v3H6V9z"></path>
      </svg>      <a href="#d2h-968562" class="d2h-file-name">src/administrator/components/com_foos/sql/updates/mysql/10.0.0.sql</a>
      <span class="d2h-file-stats">
...
<div class="line-num2">2</div>
    ...
    <td class="d2h-ins">
        <div class="d2h-code-line d2h-ins">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">&lt;access component=&quot;com_foos&quot;&gt;</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<div class="line-num2">3</div>
    ...
    <td class="d2h-ins">
        <div class="d2h-code-line d2h-ins">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">	&lt;section name=&quot;component&quot;&gt;</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<div class="line-num2">4</div>
    ...
    <td class="d2h-ins">
        <div class="d2h-code-line d2h-ins">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">		&lt;action name=&quot;core.admin&quot; title=&quot;JACTION_ADMIN&quot; &#x2F;&gt;</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<div class="line-num2">5</div>
    ...
    <td class="d2h-ins">
        <div class="d2h-code-line d2h-ins">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">		&lt;action name=&quot;core.options&quot; title=&quot;JACTION_OPTIONS&quot; &#x2F;&gt;</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<div class="line-num2">6</div>
    ...
    <td class="d2h-ins">
        <div class="d2h-code-line d2h-ins">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">		&lt;action name=&quot;core.manage&quot; title=&quot;JACTION_MANAGE&quot; &#x2F;&gt;</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<div id="d2h-113891" class="d2h-file-wrapper" data-lang="xml">
    ...
    <td class="d2h-code-linenumber d2h-info"></td>
    <td class="d2h-info">
        <div class="d2h-code-line d2h-info">@@ -15,4 +15,19 @@</div>
    </td>
</tr><tr>
...
<div class="line-num2">20</div>
    ...
    <td class="d2h-ins">
        <div class="d2h-code-line d2h-ins">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">		label=&quot;JCONFIG_PERMISSIONS_LABEL&quot;</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<div class="line-num2">21</div>
    ...
    <td class="d2h-ins">
        <div class="d2h-code-line d2h-ins">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">		description=&quot;JCONFIG_PERMISSIONS_DESC&quot;</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<div class="line-num2">24</div>
    ...
    <td class="d2h-ins">
        <div class="d2h-code-line d2h-ins">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">			name=&quot;rules&quot;</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<div class="line-num2">25</div>
    ...
    <td class="d2h-ins">
        <div class="d2h-code-line d2h-ins">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">			type=&quot;rules&quot;</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<div class="line-num2">27</div>
    ...
    <td class="d2h-ins">
        <div class="d2h-code-line d2h-ins">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">			validate=&quot;rules&quot;</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<div class="line-num2">28</div>
    ...
    <td class="d2h-ins">
        <div class="d2h-code-line d2h-ins">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">			filter=&quot;rules&quot;</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<div class="line-num2">29</div>
    ...
    <td class="d2h-ins">
        <div class="d2h-code-line d2h-ins">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">			component=&quot;com_foos&quot;</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<div class="line-num2">30</div>
    ...
    <td class="d2h-ins">
        <div class="d2h-code-line d2h-ins">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">			section=&quot;component&quot;</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<div id="d2h-863218" class="d2h-file-wrapper" data-lang="xml">
    ...
    <td class="d2h-code-linenumber d2h-info"></td>
    <td class="d2h-info">
        <div class="d2h-code-line d2h-info">@@ -21,6 +21,11 @@</div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-cntx">
...
<div class="line-num2">24</div>
    ...
    <td class="d2h-ins">
        <div class="d2h-code-line d2h-ins">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">	&lt;update&gt;  &lt;!-- Runs on update --&gt;</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<div class="line-num2">25</div>
    ...
    <td class="d2h-ins">
        <div class="d2h-code-line d2h-ins">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">		&lt;schemas&gt;</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<div class="line-num2">26</div>
    ...
    <td class="d2h-ins">
        <div class="d2h-code-line d2h-ins">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">			&lt;schemapath type=&quot;mysql&quot;&gt;sql&#x2F;updates&#x2F;mysql&lt;&#x2F;schemapath&gt;</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<tr>
    <td class="d2h-code-linenumber d2h-info"></td>
    <td class="d2h-info">
        <div class="d2h-code-line d2h-info">@@ -38,6 +43,7 @@</div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-cntx">
...
<div id="d2h-861015" class="d2h-file-wrapper" data-lang="xml">
    ...
    <td class="d2h-code-linenumber d2h-info"></td>
    <td class="d2h-info">
        <div class="d2h-code-line d2h-info">@@ -25,5 +25,12 @@</div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-cntx">
      <div class="line-num1">25</div>
...
<div id="d2h-929815" class="d2h-file-wrapper" data-lang="sql">
    ...
    <td class="d2h-code-linenumber d2h-info"></td>
    <td class="d2h-info">
        <div class="d2h-code-line d2h-info">@@ -9,3 +9,7 @@ INSERT INTO `#__foos_details` (`name`) VALUES</div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-cntx">
...
<div id="d2h-968562" class="d2h-file-wrapper" data-lang="sql">
    <div class="d2h-file-header">
    <span class="d2h-file-name-wrapper">
    <svg aria-hidden="true" class="d2h-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12">
        <path d="M6 5H2v-1h4v1zM2 8h7v-1H2v1z m0 2h7v-1H2v1z m0 2h7v-1H2v1z m10-7.5v9.5c0 0.55-0.45 1-1 1H1c-0.55 0-1-0.45-1-1V2c0-0.55 0.45-1 1-1h7.5l3.5 3.5z m-1 0.5L8 2H1v12h10V5z"></path>
    </svg>    <span class="d2h-file-name">src/administrator/components/com_foos/sql/updates/mysql/10.0.0.sql</span>
    <span class="d2h-tag d2h-added d2h-added-tag">ADDED</span></span>
    </div>
    <div class="d2h-file-diff">
        <div class="d2h-code-wrapper">
...
<div id="d2h-841411" class="d2h-file-wrapper" data-lang="php">
    ...
    <td class="d2h-code-linenumber d2h-info"></td>
    <td class="d2h-info">
        <div class="d2h-code-line d2h-info">@@ -48,9 +48,17 @@ class FoosModel extends ListModel</div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-cntx">
...
<div class="line-num2">51</div>
    ...
    <td class="d2h-ins d2h-change">
        <div class="d2h-code-line d2h-ins d2h-change">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">			$db-&gt;quoteName(array(&#x27;<ins>a.</ins>id&#x27;, &#x27;<ins>a.</ins>name&#x27;, &#x27;<ins>a.</ins>alias&#x27;<ins>, &#x27;a.access&#x27;</ins>))</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-cntx">
...
<div class="line-num2"></div>
    ...
    <td class="d2h-del d2h-change">
        <div class="d2h-code-line d2h-del d2h-change">
            <span class="d2h-code-line-prefix">-</span>
            <span class="d2h-code-line-ctn"><del>		$query-&gt;from($db-&gt;quoteName(&#x27;#__foos_details&#x27;));</del></span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins d2h-change">
...
<div class="line-num2">56</div>
    ...
    <td class="d2h-ins">
        <div class="d2h-code-line d2h-ins">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">		&#x2F;&#x2F; Join over the asset groups.</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<div class="line-num2">57</div>
    ...
    <td class="d2h-ins">
        <div class="d2h-code-line d2h-ins">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">		$query-&gt;select($db-&gt;quoteName(&#x27;ag.title&#x27;, &#x27;access_level&#x27;))</span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<tr>
    <td class="d2h-code-linenumber d2h-info"></td>
    <td class="d2h-info">
        <div class="d2h-code-line d2h-info">@@ -57,14 +58,21 @@ class HtmlView extends BaseHtmlView</div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-cntx">
...
<div class="line-num2"></div>
    ...
    <td class="d2h-del d2h-change">
        <div class="d2h-code-line d2h-del d2h-change">
            <span class="d2h-code-line-prefix">-</span>
            <span class="d2h-code-line-ctn">		$<del>toolbar</del>-&gt;<del>addNew</del>(&#x27;<del>foo</del>.<del>add</del>&#x27;)<del>;</del></span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins d2h-change">
...
<div class="line-num2">68</div>
    ...
    <td class="d2h-ins d2h-change">
        <div class="d2h-code-line d2h-ins d2h-change">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">		<ins>if (</ins>$<ins>canDo</ins>-&gt;<ins>get</ins>(&#x27;<ins>core</ins>.<ins>create</ins>&#x27;)<ins>)</ins></span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<div class="line-num2"></div>
    ...
    <td class="d2h-del d2h-change">
        <div class="d2h-code-line d2h-del d2h-change">
            <span class="d2h-code-line-prefix">-</span>
            <span class="d2h-code-line-ctn">		$<del>toolbar</del>-&gt;<del>preferences</del>(&#x27;<del>com_foos</del>&#x27;)<del>;</del></span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins d2h-change">
...
<div class="line-num2">73</div>
    ...
    <td class="d2h-ins d2h-change">
        <div class="d2h-code-line d2h-ins d2h-change">
            <span class="d2h-code-line-prefix">+</span>
            <span class="d2h-code-line-ctn">		<ins>if (</ins>$<ins>canDo</ins>-&gt;<ins>get</ins>(&#x27;<ins>core.options</ins>&#x27;)<ins>)</ins></span>
        </div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-ins">
...
<div id="d2h-426783" class="d2h-file-wrapper" data-lang="php">
    ...
    <td class="d2h-code-linenumber d2h-info"></td>
    <td class="d2h-info">
        <div class="d2h-code-line d2h-info">@@ -25,6 +25,7 @@ $tmpl    = $isModal || $input->get('tmpl', '', 'cmd') === 'component' ? '&tmpl=c</div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-cntx">
      <div class="line-num1">25</div>
...
<div id="d2h-900341" class="d2h-file-wrapper" data-lang="php">
    ...
    <td class="d2h-code-linenumber d2h-info"></td>
    <td class="d2h-info">
        <div class="d2h-code-line d2h-info">@@ -27,6 +27,9 @@ use Joomla\CMS\Router\Route;</div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-cntx">
      <div class="line-num1">27</div>
...
<tr>
    <td class="d2h-code-linenumber d2h-info"></td>
    <td class="d2h-info">
        <div class="d2h-code-line d2h-info">@@ -47,6 +50,9 @@ use Joomla\CMS\Router\Route;</div>
    </td>
</tr><tr>
    <td class="d2h-code-linenumber d2h-cntx">
