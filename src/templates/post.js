...
export default function PostTemplate({ data }) {
  ...
  const { tags, title, date, thumbnail, syndication, booklink, set } = post.frontmatter
      ...
      <article className="h-entry">
        ...
        <header>
          <div className="container">
            ...
            <div className="post-booklink">
            <br /> 
              {booklink && (
                <div className="booklink">
                              <Link to={`/${set}`}>Set </Link>as

                      <a className="u-booklink" href={booklink}>PDF & E-PUB</a>
                      <br/>
                </div>
              )}
            </div>
